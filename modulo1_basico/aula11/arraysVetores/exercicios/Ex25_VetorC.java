...
public class Ex25_VetorC {
    public static void main(String[] args) {
        //25- Criar dois vetores A e B cada um com 10 elementos inteiros. Construir um vetor C de mesmo tipo e tamanho,
        ...
        for (int i = 0; i < vetorA.length; i++) {
            System.out.print("Informe um número para a posição A " + i + ": ");
            vetorA[i] = scan.nextInt();
        }

        for (int i = 0; i < vetorB.length; i++) {
            System.out.print("Informe um número para a posição B " + i + ": ");
